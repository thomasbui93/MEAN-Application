 ...
 */
'use strict';
angular.module('voluntr').controller('userDashboardController', ['$scope', 'ERRORS', 'Validation', '$timeout', '$rootScope', 'Restangular', 'managedOrganisations',
  'representOrganisations', 'events',
  function($scope, ERRORS, Validation, $timeout, $rootScope, Restangular, managedOrganisations, representOrganisations, events) {
    $scope.edit = {
      show: false,
      state: 'Save',
      success: false
